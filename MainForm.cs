...
namespace PR6
{
    public partial class MainForm : Form
    {
        ...
        Dictionary<string, Dictionary<string, string>> foreignKeysMap = new Dictionary<string, Dictionary<string, string>>
        {
            ...
            {
                ["ин_партнера"] = "партнеры"
            },
            ["поставки"] = new Dictionary<string, string>
            {
                ["ин_поставщика"] = "партнеры"
            }
        };
        ...
        public MainForm()
        {
            ...
            conn.Open();
            comboBox1.Items.AddRange(new string[] { "сотрудники", "партнеры", "продукция", "поставки" });
        ...
        private void LoadLookupTables()
        {
            ...
            {
                string keyColumn = "ин";
                string valueColumn = "наименование_партнера";
        ...
        private Dictionary<int, string> LoadLookup(string table, string key, string column)
        {
            ...
            {
                MessageBox.Show($"Ошибка при загрузке таблицы {table}: {ex.Message}");
            }
            return dict;
        }
