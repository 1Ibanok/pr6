...
namespace PR6
{
    public partial class SalesForm : Form
    {
        ...
        void LoadSales()
        {
            cmd = new NpgsqlCommand("select тип_партнера, партнеры.наименование_партнера партнер, контактное_лицо, телефон, рейтинг, sum(сумма) сумма from продукция, партнеры where партнеры.ин = ин_партнера group by тип_партнера, партнер, контактное_лицо, телефон, рейтинг order by партнер;", MainForm.conn);
            ...
            while (reader.Read())
            {
                Label partnerLabel = new Label();
                {
                    ...
                    partnerLabel.Text = reader["тип_партнера"].ToString()  + " | " + reader["партнер"].ToString();
                }
                ...
                Label directorLabel = new Label();
                {
                    ...
                    directorLabel.Text = reader["контактное_лицо"].ToString();
                }
                ...
                Label ratingLabel = new Label();
                {
                    ...
                    ratingLabel.Text = reader["сумма"].ToString();
                }
